...
namespace OpenRCT2::Ui::Windows
{
    ...
    static Widget window_new_campaign_widgets[] = {
        ...
        MakeWidget        ({ 14, 24}, {126, 14}, WindowWidgetType::Label,    WindowColour::Primary, STR_EMPTY                                  ), // ride label
        MakeWidget        ({100, 24}, {242, 14}, WindowWidgetType::DropdownMenu, WindowColour::Primary, STR_EMPTY                              ), // ride dropdown
        ...
        MakeSpinnerWidgets({100, 41}, {100, 14}, WindowWidgetType::Spinner,  WindowColour::Primary, STR_EMPTY                                  ), // weeks (3 widgets)
        //MakeWidget        ({ 14, 58}, {100, 14}, WindowWidgetType::Label,    WindowColour::Primary, STR_MARKETING_COST_PER_WEEK                ), // costs per week
        //MakeWidget        ({ 14, 73}, {100, 14}, WindowWidgetType::Label,    WindowColour::Primary, STR_MARKETING_TOTAL_COST                   ), // costs per week
